...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
    ...
    <br />
    <br />
    <asp:GridView ID="dgvcasy" AllowPaging="True" PageSize="10" runat="server" AutoGenerateColumns="False" CellPadding="5" ForeColor="#333333" GridLines="None" Width="1000px"  HorizontalAlign="Center" Font-Size="18px"  >
        ...
        <Columns>
            ...
            <asp:BoundField HeaderText="Giới Thiệu" DataField="Story" />
